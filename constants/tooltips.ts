...
export const comicBannerTooltipText = '.png if transparent background, otherwise .jpg or .jpeg'
export const comicCoverTooltipText = '.jpg or .jpeg formats preferred, .png allowed'
export const comicPfpTooltipText = '.png if transparent background, otherwise .jpg, .jpeg, or .gif'
export const comicLogoTooltipText = '.png or .gif with transparent background'
export const comicIssueCoverImageTooltipText = '.jpg or .jpeg formats preferred, .png allowed'
export const comicIssuePagesTooltipText = 'optimized .jpg or .jpeg formats preferred for optimal download speed'
export const creatorVisualIdentityTooltipText = '.jpg and .jpeg preferred if no transparency'
export const comicIssueAuthorsTooltipText = 'A list of artists which were involved in the creative process'
